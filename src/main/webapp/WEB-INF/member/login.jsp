    ...
    <div class="container">
      <div class="row">
        <div class="mx-auto col-md-6 col-10 bg-white p-5">
          ...
          <form name="login_frm" action="/damoim/member/login.do" method="post">
            <div class="form-group"> <input type="text" name="mem_id"
            class="form-control border-dark" placeholder="ID를 입력하세요" id="form9">
            </div>
            <div class="form-group mb-3 border-dark"> <input type="password" 
            name="mem_pass" class="form-control border-dark" placeholder="Password"
            id="form10"> <small class="form-text text-muted text-right">
