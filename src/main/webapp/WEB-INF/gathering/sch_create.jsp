				...
				<div class="col-xl-12">
					<div class="card-body">
						<h5 class="card-title" style="font-weight: 400; font-size: 24px;">
							모임생성</h5>
						<form class="" action="/damoim/gathering/create.do">
							...
							<div class="position-relative row form-group">
								<label for="exampleText" class="col-xl-2 col-form-label">최대인원</label>
								<div class="col-xl-10">
							...
							<div class="position-relative row form-check">
								<div class="col-xl-12">
									<a
										href="http://localhost:8088/damoim/gathering/sch_createFinish.do"
										onclick="window.open(this.href, '_self', 'width=600px,height=400px,toolbars=no,scrollbars=no'); return false;"><button
											type="submit" class="btn btn-secondary">Create</button></a>
								</div>
							</div>
