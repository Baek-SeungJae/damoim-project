							...
							<div class="table-responsive">
								<table style="width: inherit;">
									<tbody align="center" style="font-size: 0.9vmax;">
										<tr>
											<td style="width: 20%;"><span>댓글 </span><span style="color: red;">5</span></td>
											...
											<td style="width: 35%; text-align:left;"><a class="btn btn-primary" href="#" style="font-size: 0.9vmax; padding: 0.1rem 0.3rem;"><%=board.getBoard_like() %>&nbsp;&nbsp;&nbsp;<span class="oi oi-thumb-up"></span></a></td>
										</tr>
									</tbody>
								</table>
